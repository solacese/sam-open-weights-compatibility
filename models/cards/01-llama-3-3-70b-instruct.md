...
| Field | Value |
|---|---|
| HF repo | `meta-llama/Llama-3.3-70B-Instruct` |
| Organization | Meta |
...
- **Notes:** Best all-round open tool caller; in SAM modelinfo. Llama 3 has no parallel tool calls.
...
```bash
export SAM_TEST_MODEL="openai/meta-llama/Llama-3.3-70B-Instruct"
